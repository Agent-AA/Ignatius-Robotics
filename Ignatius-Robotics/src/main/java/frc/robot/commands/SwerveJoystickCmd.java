...
public class SwerveJoystickCmd extends Command {     //Changed to Command from CommandBase
    ...
    public void initialize() {
        System.out.println("SwerveSubsystem Initilizing");
    }

    @Override
    public void execute() {
        System.out.println("SwerveSubsystem Executing");
...
//MANUALLY SETTING SPEEDS END
    ...
    public void end(boolean interrupted) {
        System.out.println("SwerveSubsystem Ending");
        swerveSubsystem.stopModules();
    }

    @Override
    public boolean isFinished() {
        System.out.println("SwerveSubsystem Finished");
        return false;
    }
}